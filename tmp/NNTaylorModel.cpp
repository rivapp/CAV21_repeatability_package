...
{
  //fix
  //expansion.add_assign(tm.expansion.monomials);
...
{
  //fix
        // list<shared_ptr<NNMonomial>> tm_monomials;
	// for(int i = 0; i < tms.size(); i++){
	//         tm_monomials.splice(tm_monomials.end(), tms[i]->expansion.monomials);
	// }

	// expansion.add_assign(tm_monomials);
			   ...
			   const Interval & cutoff_threshold, const int order) const
{
	...
	else
	{
		...
		// printf("elapsed addAssign time insert: %f\n", addAssignTime / 1000000000.0);		
		// printf("elapsed mult time insert: %f\n", mulTime / 1000000000.0);
		// printf("elapsed remainder time insert: %f\n", remTime / 1000000000.0);
		// printf("elapsed cutoff time insert: %f\n", cutoffTime / 1000000000.0);
		// printf("elapsed toHF time insert: %f\n", toHFtime / 1000000000.0);
		// printf("elapsed time insert: %f\n", (double) duration.count() / 1000000000.0);
		
		//result.expansion.add_assign(result_poly.monomials);
